...
"""Verify that starting hippocrates with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start hippocrates with -h for help text")
        ...
        self.log.info("Start hippocrates with -version for version information")
        ...
        self.log.info("Start hippocratesd with -fakearg to make sure it does not start")
