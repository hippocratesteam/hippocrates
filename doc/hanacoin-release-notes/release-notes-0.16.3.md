Hippocrates Core version 0.16.3 is now available from:
...
### Miscellaneous
- #13655 `1cdbea7` hippocratesconsensus: invalid flags error should be set to `hippocratesconsensus_err` (afk11)
