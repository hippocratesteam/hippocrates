# Support for Output Descriptors in Hippocrates Core

Since Hippocrates Core v0.17, there is support for Output Descriptors in the
...
on Hippocrates's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Hippocrates Core wallets, a convenience function `combo` is
